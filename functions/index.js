    ...
    .onCreate((snap, context) =>{
      ...
      database.ref('matchmaking').once('value').then(players =>{
        ...
        database.ref('matchmaking').transaction(function(matchmaking) {
          ...
          if (matchmaking === null || matchmaking[context.params.playerId] !== 'placeholder' ||
          matchmaking[secondPlayer.key] !== 'placeholder') return matchmaking;
          ...
          var game = {
            gameInfo: {
              ...
              loadedLevel: 'mapa' + String(Math.floor(Math.random() * 3) + 1),
